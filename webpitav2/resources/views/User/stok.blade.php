...
{{-- Form Import Excel --}}
<form action="{{ route('user.barang.import') }}" method="POST" enctype="multipart/form-data" style="margin-top:10px; margin-bottom:10px;">
    @csrf
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <form action="{{ url('/user/stok/'.$b->id) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
